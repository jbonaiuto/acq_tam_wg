...
import acq_tam_wg.RatBrain.v1_1_1.src.*;
import acq_tam_wg.SimWorld.v1_1_2.src.*;
import acq_tam_wg.ModelAvatar.v1_1_1.src.*;
...
//variables 
public  acq_tam_wg.RatBrain.v1_1_1.src.RatBrain ratBrain; // 
public  acq_tam_wg.SimWorld.v1_1_2.src.SimWorld world; // 
private BackgroundSound sound; // 
public  acq_tam_wg.ModelAvatar.v1_1_1.src.ModelAvatar avatar; // 
...
public void initTrain()
{
	...
	if(randInitPosition)
	{
		int startIdx=(int)(NslRandom.eval()*(world.nodeCount-1));
...
{ 
		...
		ratBrain = new acq_tam_wg.RatBrain.v1_1_1.src.RatBrain("ratBrain", this, angleRepSize, numDrives, maxNodes, actionThreshold);
		world = new acq_tam_wg.SimWorld.v1_1_2.src.SimWorld("world", this, numDrives, mapSize, maxNodes);
		avatar = new acq_tam_wg.ModelAvatar.v1_1_1.src.ModelAvatar("avatar", this, angleRepSize, actionThreshold);
