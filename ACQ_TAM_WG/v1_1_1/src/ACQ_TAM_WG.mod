...
//variables 
public acq_tam_wg.MotivationalSchema.v1_1_1.src.MotivationalSchema motivationalSchema(numDrives, angleRepSize, mapSize, d_min, d_max); // 
public acq_tam_wg.IncentiveStimuli.v1_1_1.src.IncentiveStimuli incentives(angleRepSize, numDrives, incentiveSigma); // 
public acq_tam_wg.Actor.v1_1_1.src.Actor actor(angleRepSize, numDrives, signalThreshold, actionThreshold); // 
public acq_tam_wg.SimWorld.v1_1_1.src.SimWorld world(numDrives, mapSize, maxNodes); // 
public acq_tam_wg.ModelPerspectiveView.v1_1_1.src.ModelPerspectiveView modelView(angleRepSize, actionThreshold); // 
public acq_tam_wg.WorldGraph.v1_1_1.src.WorldGraph wg(angleRepSize, numDrives, d_min, d_max, maxNodes, wgDesirabilitySigma); // 
...
public acq_tam_wg.PPC.v1_1_2.src.PPC ppc(angleRepSize, maxNodes, affordanceSigma); // 
