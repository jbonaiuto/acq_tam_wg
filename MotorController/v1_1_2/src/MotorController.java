...
protected void process()
{
	...
	{
		double[] directionVec= new  double[]{NslOperator.sin.eval(orientationDelta.get()+currentOrientation.get()),NslOperator.cos.eval(orientationDelta.get()+currentOrientation.get())};
...
{ 
		...
		orientationDelta = new NslDinDouble0("orientationDelta", this);
